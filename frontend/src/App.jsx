...
import TripPlanDetail from "./pages/traveler/TripPlanDetail";
          ...
          <Routes>
            ...
            <Route element={<AppLayout />}>
              <Route element={<ProtectedRoute allowedRoles={["TRAVELER"]} />}>
                ...
                <Route
                  path="/traveler/ai-planner"
                  element={<AITripPlanner />}
                />
                <Route
                  path="/traveler/ai-planner/:sessionId"
                  element={<TripPlanDetail />}
                />
              ...
              <Route element={<ProtectedRoute allowedRoles={["BUSINESS"]} />}>
                ...
                <Route
                  ...
                  element={<GuideServicesManagement />}
                />
              ...
              <Route
                element={
                  <ProtectedRoute
                    allowedRoles={["HOTEL_ADMIN", "PLATFORM_ADMIN"]}
                  />
                }
              >
              ...
              <Route
                element={
                  <ProtectedRoute
                    allowedRoles={["TOUR_OPERATOR", "PLATFORM_ADMIN"]}
                  />
                }
              >
                <Route
